...
| D25 | 2026-04-24 | Proposed   | Extract kube-prometheus-stack into a standalone ArgoCD Application        | Shared AppSet `ignoreDifferences` coexists with the Kyverno image-mutation policy; KPS is excluded from that policy and breaks under stripping. See [D25-kps-standalone-application.md](D25-kps-standalone-application.md) |
