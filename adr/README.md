...
| D17 | 2026-04-03 | Accepted   | Adopt CloudNativePG for managed PostgreSQL                                | CNCF Sandbox, ARM64 native, replace Harbor internal DB. See [D17-cloudnativepg.md](D17-cloudnativepg.md) |
...
| D20 | 2026-04-03 | Superseded | Migrate Harbor to ARM64                                                   | Superseded by D24. See [D20-harbor-on-arm.md](D20-harbor-on-arm.md) |
...
| D23 | 2026-04-05 | Proposed   | Security hardening — credentials, workload security, access reduction     | Remediate audit findings: migrate secrets, add security contexts, reduce exposure. See [D23-security-hardening.md](D23-security-hardening.md) |
| D24 | 2026-04-06 | Proposed   | Replace Harbor with Zot Registry                                          | ARM64-native registry with built-in Trivy scanning, pull-through cache, web UI. Supersedes D20. See [D24-zot-registry.md](D24-zot-registry.md) |
| D25 | 2026-04-26 | Proposed   | Split infrastructure-tier charts into a dedicated ApplicationSet          | Charts whose namespaces are Kyverno-excluded (KPS, Zot) move to a sibling `applications-infrastructure` AppSet that omits the image-stripping `ignoreDifferences` block. See [D25-applications-infrastructure-appset.md](D25-applications-infrastructure-appset.md) |
| D26 | 2026-04-26 | Proposed   | Sync-wave tiering for ArgoCD AppSets                                      | Encode 3-tier deploy order via `argocd.argoproj.io/sync-wave` (foundation 0, platform 10, workloads 20) on each AppSet plus its template. See [D26-appset-sync-waves.md](D26-appset-sync-waves.md) |
| D27 | 2026-06-10 | Proposed   | conveyor-system runs outside GitOps as a documented, time-boxed exception | Deployed from OpenConveyor dev repo; adoption trigger: release or 2026-09-10. See [D27-conveyor-gitops-exception.md](D27-conveyor-gitops-exception.md) |
